...
class Base:
    ...
    (e.g. 'ubuntu@22.04_ccchub1_amd64')
    """
    ...
    def from_charmcraft_yaml_base(cls, base: dict, *, base_index: int):
        ...
        if build_on_architectures:
            ...
            ), f"Multiple architectures ({build_on_architectures}) in one (charmcraft.yaml) base entry not supported. Use one entry per architecture"
        ...
        return cls(
            ...
            name_in_artifact=f'ubuntu@{base["channel"]}_ccchub1_{architecture}',
        )
